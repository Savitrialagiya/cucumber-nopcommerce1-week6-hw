...
public class ComputerSteps {
    ...
    public void iEnterTextToFirstNameField() {
        new ComputerPage().enterTextToFirstNameField("Adam");
    }

    @And("^I enter Text To Last Name Field$")
    public void iEnterTextToLastNameField() {
        new ComputerPage().enterTextToLastNameField("Smith");
    }

    @And("^I enter Text To email Field$")
    public void iEnterTextToEmailField() {
        new ComputerPage().enterTextToEmailField("adam1@gmail.com");
    }
    ...
    public void iSendTextTOCardNumber() {
        new ComputerPage().sendTextTOCardNumber("5555555555554444");
    }
    ...
    public void iSendTextToCardCode() {
        new ComputerPage().sendTextToCardCode("802");
    }
